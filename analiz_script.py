...
# --- AYARLAR ---
ANALIZ_SURESI_AY = 3
MANUAL_FON_KODLARI = ['AAS', 'AFA', 'AFS', 'AFT', 'AFV', 'AKE', 'ARE', 'ASJ', 'AUV', 'BHA', 'BDS', 'BRF', 'BRT', 'BTE', 'BUY', 'BUV', 'BVM', 'BVV', 'CIN', 'CKF', 'CKL', 'CPT', 'CPU', 'DBH', 'DFC', 'DHM', 'DMG', 'DOH', 'DOV', 'DPB', 'DSD', 'DTL', 'DTZ', 'DVT', 'DXP', 'DYN', 'DZM', 'EID', 'ENJ', 'ESG', 'ESP', 'EUN', 'FBC', 'EUZ', 'FBZ', 'FBV', 'FCK', 'FDG', 'FJB', 'FKE', 'FLS', 'FLY', 'FMG', 'FPG', 'FSH', 'FSR', 'FUB', 'GBC', 'GBG', 'GBV', 'GIH', 'GMC', 'GMR', 'GNH', 'GNS', 'GO3', 'GO4', 'GPG', 'GPT', 'GTZ', 'GUH', 'GUM', 'GVA', 'GZL', 'GZG', 'GZY', 'GZV', 'GZZ', 'HGM', 'HGV', 'HIZ', 'HOA', 'HOY', 'HRZ', 'HVU', 'HTJ', 'IAE', 'IBB', 'ICH', 'IDO', 'IDY', 'IEV', 'IFN', 'IHC', 'IJB', 'IJP', 'IJT', 'IKL', 'IJC', 'IKP', 'IMB', 'IML', 'IPG', 'IOG', 'IPJ', 'IRO', 'IRT', 'IUF', 'IUV', 'ITP', 'IYB', 'IUH', 'IVY', 'IZS', 'KAV', 'KGM', 'KHA', 'KHT', 'KIB', 'KKC', 'KLH', 'KP3', 'KRS', 'KUT', 'KVT', 'KUB', 'KYS', 'MAC', 'MET', 'MGB', 'MHF', 'MJL', 'MJG', 'MPP', 'MRI', 'MTG', 'MTX', 'MTV', 'NHY', 'NME', 'NKP', 'NTI', 'NUB', 'NVZ', 'ODP', 'ODD', 'OJT', 'OLD', 'OLA', 'ONE', 'ONK', 'OPF', 'OTM', 'PBI', 'PBN', 'PIL', 'PMP', 'POS', 'PP1', 'PPE', 'PPH', 'PPS', 'PYR', 'RBL', 'RBN', 'RDF', 'RHI', 'RPD', 'RPS', 'RPM', 'RTD', 'RTG', 'RTH', 'SBH', 'RUT', 'SPE', 'SOS', 'SPR', 'SSK', 'ST1', 'SUC', 'TCC', 'TFF', 'TEJ', 'TGR', 'THF', 'TJF', 'TKF', 'TJT', 'TLH', 'TLY', 'TMG', 'TMZ', 'TPV', 'TPP', 'URA', 'VCY', 'YAY', 'YBE', 'YBR', 'YBH', 'YIT', 'YJK', 'YLC', 'YLO', 'YPC', 'YSO', 'YTD', 'YTY', 'YZG', 'YVG', 'ZFB', 'ZMT', 'ZMY', 'ZP9']
